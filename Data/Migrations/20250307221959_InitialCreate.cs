    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("expense_category_pkey", x => x.expense_category_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    income_category_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    name = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("income_category_pkey", x => x.income_category_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "expense_expense_category_id_fkey",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    income_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    user_id = table.Column<string>(type: "text", nullable: true),
                    income_category_id = table.Column<int>(type: "integer", nullable: true),
                    time = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    sum = table.Column<double>(type: "double precision", nullable: false),
                    details = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("income_pkey", x => x.income_id);
                    table.ForeignKey(
                        name: "income_income_category_id_fkey",
